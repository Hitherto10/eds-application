...
export default function ClassSetupBuilder() {
    ...
    const loadRegistryStyle = (styleId) => {
        ...
        // 1. Replace the levels instead of appending them
        setBaseLevels(style.levels);

        // 2. Rebuild the matrix from scratch for these levels
        const newMatrix = {};
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 min-h-full items-stretch">
                    ...
                    <div className="w-full lg:w-[350px] shrink-0 flex flex-col gap-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            <h3 className="text-xs uppercase font-black text-gray-400 tracking-widest mb-3">1. Select Base Structure</h3>
                            ...
                            {baseLevels.length === 0 ? (
                                ...
                                <table className="w-full text-left border-collapse">
                                    ...
                                    <tr>
                                        ...
                                        {streams.map(st => (
                                            <th key={st} className="p-3 bg-gray-50 border-b border-gray-200 text-xs font-black uppercase text-gray-500 tracking-wider sticky top-0 text-center min-w-20">
                                                {st}
                                            </th>
                                        ))}
                                    </tr>
